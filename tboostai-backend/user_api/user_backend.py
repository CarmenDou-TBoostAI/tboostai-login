...
from user_database import create_db_and_tables, get_session
from user_models import UserAccount, GoogleAuthRequest, EmailVerificationRequest, CompleteProfileRequest, EmailCodeVerificationRequest,EmailUserCreateRequest
from fastapi import FastAPI, Depends, HTTPException, Request as FastAPIRequest, Query
...
gmail_service = GmailService("carmen.dou.tboostai@gmail.com")
